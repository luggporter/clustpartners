            ...
            <Router>
                <Suspense fallback={<Preloader />}>
                    <Routes>
                        ...
                        >
                            {/* Dashboard Routes */}
                            <Route path="/classic-plus/dashboard-one" element={<ClassicPlusDashboardOne />} />
                            <Route path="/classic-plus/dashboard-two" element={<ClassicPlusDashboardTwo />} />
                            <Route path="/classic-plus/dashboard-three" element={<ClassicPlusDashboardThree />} />
                            <Route path="/classic-plus/dashboard-four" element={<ClassicPlusDashboardFour />} />
                            <Route path="/classic-plus/dashboard-five" element={<ClassicPlusDashboardFive />} />

                            {/* Authentication Routes */}
                            <Route path="/classic-plus/signin" element={<ClassicPlusSignIn />} />
                            <Route path="/classic-plus/signup" element={<ClassicPlusSignUp />} />
                            <Route path="/classic-plus/verify-account" element={<ClassicPlusVerifyAccount />} />
                            <Route path="/classic-plus/forgot-password" element={<ClassicPlusForgotPassword />} />

                            {/* Error Routes */}
                            <Route path="/classic-plus/error-500" element={<ClassicPlusError500 />} />
                            <Route path="/classic-plus/error-503" element={<ClassicPlusError503 />} />
                            <Route path="/classic-plus/error-505" element={<ClassicPlusError505 />} />
                            <Route path="/classic-plus/error-404" element={<ClassicPlusErrorNotFound />} />

                            {/* User Routes */}
                            <Route path="/classic-plus/profile-view" element={<ClassicPlusProfileView />} />
                            <Route path="/classic-plus/connections" element={<ClassicPlusConnections />} />
                            <Route path="/classic-plus/groups" element={<ClassicPlusGroups />} />
                            <Route path="/classic-plus/events" element={<ClassicPlusEvents />} />

                            {/* Other Routes */}
                            <Route path="/classic-plus/timeline" element={<ClassicPlusTimeline />} />
                            <Route path="/classic-plus/pricing" element={<ClassicPlusPricing />} />
                            <Route path="/classic-plus/help-center" element={<ClassicPlusHelpCenter />} />
                            <Route path="/classic-plus/invoice" element={<ClassicPlusInvoice />} />
                        </Route>
                        ...
                        >
                            <Route path="/classic-plus/apps/calendar" element={<ClassicPlusCalendar />} />
                            <Route path="/classic-plus/apps/file-manager" element={<ClassicPlusFileManager />} />
                            <Route path="/classic-plus/apps/mail" element={<ClassicPlusMail />} />
                        </Route>
                        ...
                        >
                            <Route path="/classic-plus/apps/chat" element={<ClassicPlusChat />} />
                            <Route path="/classic-plus/apps/contacts" element={<ClassicPlusContacts />} />
                        </Route>
